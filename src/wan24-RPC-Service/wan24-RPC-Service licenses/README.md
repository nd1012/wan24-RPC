...
published in the 
[GitHub repository](https://github.com/nd1012/wan24-RPC).
...
## wan24-RPC-Servic referenced libraries

The published `wan24-RPC-Servic` library uses the following referenced open 
source libraries:

| Library | License |
| ------- | ------- |
| [`wan24-RPC`](https://github.com/WAN-Solutions/wan24-RPC) | [MIT](https://github.com/nd1012/wan24-RPC/blob/main/LICENSE) |
