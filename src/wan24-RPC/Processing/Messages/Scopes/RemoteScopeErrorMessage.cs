...
{
    /// <summary>
    /// RPC scope error message for the scope master
    /// </summary>
    /// <remarks>
    /// Constructor
    /// </remarks>
    public class RemoteScopeErrorMessage() : ScopeMessageBase()
    {
        /// <summary>
        /// RPC message type ID
        /// </summary>
        ...
        public RemoteScopeErrorMessage(in RpcProcessor.RpcRemoteScopeBase scope) : this() => ScopeId = scope.Id;
